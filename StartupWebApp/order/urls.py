...
urlpatterns = [
    ...
    re_path(r'^product/(?P<product_identifier>[a-zA-Z\d]+$)', views.product, name='product'), #matches for all character and digit product identifiers
    ...
    path('cart-update-sku-quantity', views.cart_update_sku_quantity, name='cart_update_sku_quantity'),
    path('cart-remove-sku', views.cart_remove_sku, name='cart_remove_sku'),
    path('cart-apply-discount-code', views.cart_apply_discount_code, name='cart_apply_discount_code'),
    path('cart-remove-discount-code', views.cart_remove_discount_code, name='cart_remove_discount_code'),
    path('cart-update-shipping-method', views.cart_update_shipping_method, name='cart_update_shipping_method'),
    ...
    path('anonymous-email-address-payment-lookup', views.anonymous_email_address_payment_lookup, name='anonymous_email_address_payment_lookup'),
