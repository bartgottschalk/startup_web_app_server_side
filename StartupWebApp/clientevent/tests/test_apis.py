...
class UserAPITest(PostgreSQLTestCase):
    ...
    def setUp(self):
        ...
        Ad.objects.create(
            campaignid='1871718400',
            adgroupid='70252590136',
            final_url='www.startupwebapp.com/pythonabot',
            headline_1='Hi. My name is PythonABot',
            headline_2='I can help around your house',
            description_1='The best part is that we can communicate with each other in Python!',
            final_url_suffix='ad_cd=E0y04nClr68pywMIyUxn',
            ad_type=Adtype.objects.get(
                title='Google AdWords'),
            ad_status=Adstatus.objects.get(
                title='Running'),
            ad_cd='E0y04nClr68pywMIyUxn')
    ...
    def test_linkevent(self):
        ...
        response = self.client.get(
            ...
            '&ad_cd=E0y04nClr68pywMIyUxn'
            '&url=/clientevent/linkevent?ad_cd=E0y04nClr68pywMIyUxn'
        )
        unittest_utilities.validate_response_is_OK_and_JSON(self, response)
        # print(response.content.decode('utf8'))
        self.assertEqual(response.content.decode('utf8'), '"thank you"',
                         '/clientevent/linkevent successful failed json validation')
