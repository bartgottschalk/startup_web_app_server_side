...
def isUserNameValid(username, max_length):
    ...
    if username == '':
        ...
        return errors
    # Validators return True or error array - must use != True
    if isAlphaNumericUnderscoreHyphen(username) != True:  # noqa: E712
...
def isEmailValid(email, max_length):
    ...
    if email == '':
        ...
        return errors
    # Validators return True or error array - must use != True
    if isEmail(email) != True:  # noqa: E712
...
def isPasswordValid(password, confirm_password, max_length):
    ...
    # Validators return True or error array - must use != True
    if containsCapitalLetter(password) != True:  # noqa: E712
        errors.append(password_must_contain_capital_letter)
    if containsSpecialCharacter(password) != True:  # noqa: E712
