...
class LoginAPITest(PostgreSQLTestCase):
    ...
    def test_invalid_password(self):
        ...
        self.assertFalse(response_data['logged_in'],
                         'User should not be logged in after failed login')
    ...
    def test_remember_me_true(self):
        ...
        self.assertFalse(expire_at_browser_close,
                         'Remember me session should not expire at browser close')
    ...
    def test_remember_me_false(self):
        ...
        expire_at_browser_close = self.client.session.get_expire_at_browser_close()
        self.assertTrue(expire_at_browser_close,
                        'Session should expire at browser close when remember_me=false')
    ...
    def test_cart_merge_on_login(self):
        ...
        self.assertEqual(response_data['cart_item_count'], 1,
                         'Member cart should have merged anonymous cart item')
    ...
    def test_login_with_existing_member_cart(self):
        ...
        response_data = json.loads(response.content.decode('utf8'))
        self.assertEqual(response_data['cart_item_count'], 1,
                         'Member cart should still have 1 item (no duplicates)')
