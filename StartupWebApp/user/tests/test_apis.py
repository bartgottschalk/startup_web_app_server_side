...
class UserAPITest(TestCase):
	...
	def test_create_account_member_field_initialization(self):
		...
		self.assertTrue(member.stripe_customer_token is None or member.stripe_customer_token == '',
		...
		self.assertTrue(member.reset_password_string is None or member.reset_password_string == '',
		               'Reset password string should be None or empty initially')
		self.assertTrue(member.reset_password_string_signed is None or member.reset_password_string_signed == '',
		...
		self.assertFalse(member.use_default_shipping_and_payment_info,
		                'Use default shipping/payment should be False initially')
	...
	def test_create_account_with_invalid_data_preserves_database(self):
		...
		self.assertEqual(Member.objects.count(), initial_member_count, 'No Member should be created on validation failure')
